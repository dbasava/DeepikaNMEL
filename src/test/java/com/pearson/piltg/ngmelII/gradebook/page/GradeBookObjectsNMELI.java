...
public class GradeBookObjectsNMELI {


		
		public enum gradeBookObjectsNMELI { 
			
			
			//****Gradebook***
			GRADEBOOK_HEADER_TITLE(By.id(""),By.cssSelector("div#ng_gradebook_header > h1.screen-header"),By.xpath(""),By.name(""),By.linkText("")),
			GRADEBOOK_CHANGECOURSE_SELECT(By.id("ng_gradebook_courses_list"),By.cssSelector(""),By.xpath(""),By.name(""),By.linkText("")),
			GRADEBOOK_CHANGECOURSEPRODUCT_LABEL(By.id(""),By.cssSelector("select#ng_gradebook_courses_list > optgroup"),By.xpath(""),By.name(""),By.linkText("")),
			GRADEBOOK_CHANGEATTEMPT_SELECT(By.id(""),By.cssSelector("select#ng_gradebook_attempt_list"),By.xpath(""),By.name(""),By.linkText("")),
			GRADEBOOK_GRADELOADER_IMAGE(By.id("ng_gradebook_ajax_loader"),By.cssSelector(""),By.xpath(""),By.name(""),By.linkText("")),
			...
			GRADEBOOK_PRACTICEONLY_TABLE_ROW(By.id(""),By.cssSelector(""),By.xpath("//table[@class='pneView']/tbody/tr"),By.name(""),By.linkText("")),
			...
			private gradeBookObjectsNMELI(By idLoc, By cssPathLoc, By xPathLoc, By nameObj,By linkText) {
				id = idLoc;
				cssPath = cssPathLoc;
				xPath = xPathLoc;
				name = nameObj;
